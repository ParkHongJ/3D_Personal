...
HRESULT CHierarchyNode::Initialize(CHierarchyNode* pParent, _uint iDepth, Node* pNode)
{
...
CHierarchyNode * CHierarchyNode::Create(CHierarchyNode* pParent, _uint iDepth, Node* pNode)
{
	CHierarchyNode*			pInstance = new CHierarchyNode();

	if (FAILED(pInstance->Initialize(pParent, iDepth, pNode)))
	{
