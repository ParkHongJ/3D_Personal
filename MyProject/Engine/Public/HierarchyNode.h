...
public:
	HRESULT Initialize(class CHierarchyNode* pParent, _uint iDepth, Node* pNode);
...
public:
	static CHierarchyNode* Create(class CHierarchyNode* pParent, _uint iDepth, Node* pNode);
	virtual void Free();
};
