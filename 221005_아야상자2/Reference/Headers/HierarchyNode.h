...
public:
	HRESULT Initialize(Node* pNode, class CHierarchyNode* pParent, _uint iDepth);
...
public:
	static CHierarchyNode* Create(Node* pNode, class CHierarchyNode* pParent, _uint iDepth);
	virtual void Free();
};
