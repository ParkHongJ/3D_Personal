...
public:
	...
	_matrix Get_OldTransformation()	{
		return XMLoadFloat4x4(&m_OldTransformation);
	}
...
public:
	HRESULT Initialize(aiNode* pAINode, class CHierarchyNode* pParent, _uint iDepth, Node* pNode);
...
private:
	...
	_float4x4			m_OldTransformation;
	_float4x4			m_CombinedTransformation;
	CHierarchyNode*		m_pParent = nullptr;
	_uint				m_iDepth = 0;

public:
	static CHierarchyNode* Create(aiNode* pAINode, class CHierarchyNode* pParent, _uint iDepth, Node* pNode);
	virtual void Free();
};
