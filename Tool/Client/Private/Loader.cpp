...
HRESULT CLoader::Loading_ForGamePlayLevel()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Fiona"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/Homonculus/", "Homonculus.fbx", L"../Bin/Resources/Meshes/Homonculus/", L"Homonculus.dat", PivotMatrix))))
		return E_FAIL;*/

	/* For.Prototype_Component_Model_ForkLift */
	PivotMatrix = XMMatrixScaling(0.01f, 0.01f, 0.01f) *XMMatrixRotationY(XMConvertToRadians(180.0f));
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ForkLift"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Meshes/", "Test.fbx", L"../Bin/Resources/Meshes/Boss/Effect/", L"Cylinder.dat", PivotMatrix))))
		return E_FAIL;
