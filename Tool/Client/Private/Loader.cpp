...
HRESULT CLoader::Loading_ForGamePlayLevel()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ForkLift"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Meshes/Boss/MantariField/", "MergeCircle.fbx", L"../Bin/Resources/Meshes/Boss/MantariField/", L"MergeCircle.dat", PivotMatrix))))
		return E_FAIL;
